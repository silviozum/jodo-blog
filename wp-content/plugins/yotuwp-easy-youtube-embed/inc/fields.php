	...
	<div class="yotu-radios-img-buttons yotu-radios-img yotu-radios-img-<?php echo isset($data['class'])? $data['class']:'full';?>">
		<?php
            ...
            <label class="yotu-field-radios<?php echo $selected;?>" for="<?php echo $id;?>">
            	...
            	<a href="#" class="yotu-button-prs yotu-button-prs-<?php echo $i;?>"><?php echo __('Prev', 'yotu');?></a>
            	<a href="#" class="yotu-button-prs yotu-button-prs-<?php echo $i;?>"><?php echo __('Next', 'yotu');?></a>
                <br/>
                <span><?php echo sprintf( __('Style %s', 'yotu'), $i);?></span>
            </label>
            <?php
            }
        ?>
